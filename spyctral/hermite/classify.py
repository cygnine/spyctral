...
class HermitePolynomialQuadrature(QuadratureRule):
    ...
    def __init__(self,N=0,mu=0.,affine_shift=0.,affine_scale=1.):
        self.N = N
        self.quadrature_type = "Hermite polynomial"
        self.parameters = {"mu":mu, "scale":affine_scale, "shift":affine_shift}
        if N>0:
...
class HermitePolynomialBasis(SpectralBasis):
    ...
    def __init__(self,N=0,quadrature=None,interpolation_nodes=None,
                 filter=None,mu=0.,affine_shift=0.,affine_scale=1.):
        self.N = N
        self.mu = mu;
        ...
        self.parameters = {'mu':mu, 'scale':affine_scale,
                'shift':affine_shift}
